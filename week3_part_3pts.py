...
('M7A','Downtown Toronto','Queens Park  Ontario Provincial Government'),
...
('M8Y','Etobicoke','Old Mill South  Kings Mill Park  Sunnylea  Humber Bay  Mimico NE  The Queensway East  Royal York South East  Kingsway Park South East'),
...
df = df.join(df_geospatial.set_index('Postal Code'), on='PostalCode')
df
...
print('The coordinates of Toronto {}, {}.'.format(latitude, longitude))
